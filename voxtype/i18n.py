...
STRINGS = {
    "app_name": ("VoxType", "VoxType"),
    "on": ("VoxType is ON", "VoxType ist AN"),
    "off": ("VoxType is OFF", "VoxType ist AUS"),
    ...
    "autostart": ("Start VoxType when I log in", "VoxType beim Anmelden starten"),
    "ui_language": ("App language", "App-Sprache"),
    "ui_auto": ("Automatic (system)", "Automatisch (System)"),
    "close_note": ("Closing this window does not stop VoxType.",
                   "Dieses Fenster zu schließen beendet VoxType nicht."),
